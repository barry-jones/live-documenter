...
namespace TheBoxSoftware.Reflection.Core.COFF {
	...
	public sealed class MetadataStream : Stream {
		...
		private byte sizeOfStringIndexes = 0;
		private byte sizeOfGuidIndexes = 0;
		private byte sizeOfBlobIndexes = 0;
		#endregion
		...
		public byte SizeOfStringIndexes { 
			get {
				if (this.sizeOfStringIndexes == 0) {
					this.sizeOfStringIndexes = ((this.HeapOffsetSizes & HeapOffsetSizes.StringIsLarge) == HeapOffsetSizes.StringIsLarge)
						? (byte)4
						: (byte)2;
				}
				return this.sizeOfStringIndexes;
			}
		}
		...
		public byte SizeOfGuidIndexes {
			get {
				if (this.sizeOfGuidIndexes == 0) {
					this.sizeOfGuidIndexes = ((this.HeapOffsetSizes & HeapOffsetSizes.GuidIsLarge) == HeapOffsetSizes.GuidIsLarge)
						? (byte)4
						: (byte)2;
				}
				return this.sizeOfGuidIndexes;
			}
		}
		...
		public byte SizeOfBlobIndexes {
			get {
				if (this.sizeOfBlobIndexes == 0) {
					this.sizeOfBlobIndexes = ((this.HeapOffsetSizes & HeapOffsetSizes.BlobIsLarge) == HeapOffsetSizes.BlobIsLarge)
						? (byte)4
						: (byte)2;
				}
				return this.sizeOfBlobIndexes;
			}
		}
