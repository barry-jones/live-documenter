...
namespace TheBoxSoftware.Reflection.Core.COFF
{
    ...
    public class Cor20Header
    {
        ...
        /// </summary>
        public UInt16 MajorRuntimeVersion { get; set; }

        /// <summary>
        /// Minor portion of the minimum version of the runtime required
        /// </summary>
        public UInt16 MinorRuntimeVersion { get; set; }
        ...
        /// <summary>
        /// </summary>
        public Cor20Flags Flags { get; set; }
        ...
        /// </summary>
        public UInt64 EntryPointToken { get; set; }
