...
namespace TheBoxSoftware.Reflection.Syntax
{
    ...
    internal class MethodSyntax : Syntax
    {
        ...
        public List<ParameterDetails> GetParameters()
        {
            ...
            List<ParamSignatureToken> definedParameters = new List<ParamSignatureToken>(
                _signiture.Tokens.FindAll(t => t.TokenType == SignatureTokens.Param)
                    .ConvertAll<ParamSignatureToken>(p => (ParamSignatureToken)p)
                    .ToArray()
                );
